...
//Con Cloneable, le eccezioni non vengono propagate al livello test! (Quindi non sono da testare)
public class FontInfo implements Cloneable, Serializable {
	...
	public FontInfo() { //Costruttore predefinito che inizializza il font e la sua dimensione
		super();
		setFamily(DEFAULT_FAMILY);
		setSize(12);
	}

	public FontInfo(Font font) { //Costruttre che inizializza gli attributi utilizzando un oggetto FONT (solleva un eccezione se nullo)
		super();
		if (font == null) {
	 ...
	 */
	public Object clone() { //Ritorna la copia dell'oggetto clonato, con le stesse proprietà dell'oggetto originale
		try {
			return super.clone();
	...
	//Confronta un oggetto "Font" con le proprietà FontInfo
	...
	//Ritorna un font che corrisponde alle proprietà in FontInfo
	...
	public boolean equals(Object obj) { 
		//RITORNA 'true' per oggetti identici, altrimenti false
		if (this == obj)
			return true;
		if (obj == null)
			return false;
